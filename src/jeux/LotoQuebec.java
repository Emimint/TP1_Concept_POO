...
public final class LotoQuebec extends JeuSimple {
	...
	public String toString() {
		return "Le gros lot du Loto 6/49 online:\n\n"
				...
				+ "4 / 6 : 50$\n" + "3 / 6 : 10$\n" + "2 / 6 : 3$\n\n"
				+ "Plus vous misez, plus vous augmentez vos chances de gagner: la mise minimale "
				+ "est de 3$, donc vous pouvez choisir une nouvelle combinaison de chiffres pour chaque 3 dollars misés!\n"
